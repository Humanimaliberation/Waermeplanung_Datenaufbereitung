...
<qgis labelsEnabled="0" readOnly="0" simplifyLocal="1" version="3.10.4-A Coruña" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories">
    ...
    <symbols>
      <symbol name="0" alpha="1" clip_to_extent="1" force_rhr="0" type="fill">
        <layer locked="0" class="SimpleFill" enabled="1" pass="0">
          ...
          <prop k="color" v="187,255,245,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="1,255,221,255"/>
  ...
  <aliases>
    ...
    <alias name="" index="1" field="ART"/>
    <alias name="" index="2" field="GN"/>
    <alias name="" index="3" field="KN"/>
    <alias name="" index="4" field="STAND"/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="GN" expression=""/>
    <default applyOnUpdate="0" field="KN" expression=""/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="ART"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="GN"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="KN"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="GN"/>
    <constraint desc="" exp="" field="KN"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column hidden="0" name="ART" width="-1" type="field"/>
      <column hidden="0" name="GN" width="-1" type="field"/>
      <column hidden="0" name="KN" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="GN" editable="1"/>
    <field name="KN" editable="1"/>
    <field name="STAND" editable="1"/>
    <field name="fid" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="ART" labelOnTop="0"/>
    <field name="GN" labelOnTop="0"/>
    <field name="KN" labelOnTop="0"/>
