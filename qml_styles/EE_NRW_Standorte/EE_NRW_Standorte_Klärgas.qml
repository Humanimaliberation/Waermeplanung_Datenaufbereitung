...
<qgis labelsEnabled="0" readOnly="0" simplifyLocal="1" version="3.10.4-A Coruña" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories">
  ...
  <aliases>
    ...
    <alias name="" index="7" field="KWK_Anlage"/>
    <alias name="" index="8" field="ERIKA_ID"/>
    <alias name="" index="9" field="Stand"/>
    <alias name="" index="10" field="Beschreibung"/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="KWK_Anlage" expression=""/>
    <default applyOnUpdate="0" field="ERIKA_ID" expression=""/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="KWK_Anlage"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="ERIKA_ID"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="KWK_Anlage"/>
    <constraint desc="" exp="" field="ERIKA_ID"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column hidden="0" name="KWK_Anlage" width="-1" type="field"/>
      <column hidden="0" name="ERIKA_ID" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field name="ERIKA_ID" labelOnTop="0"/>
    ...
    <field name="KWK_Anlage" labelOnTop="0"/>
