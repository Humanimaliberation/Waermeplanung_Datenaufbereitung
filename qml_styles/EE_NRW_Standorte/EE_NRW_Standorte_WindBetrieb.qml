...
<qgis labelsEnabled="0" readOnly="0" simplifyLocal="1" version="3.10.4-A Coruña" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories">
  ...
  <aliases>
    ...
    <alias name="" index="2" field="MastrID"/>
    <alias name="" index="3" field="PLZ"/>
    <alias name="" index="4" field="Gemeinde"/>
    <alias name="" index="5" field="Inbetriebnahmejahr"/>
    <alias name="" index="6" field="Genehmigungsjahr"/>
    <alias name="" index="7" field="Leistung_kW"/>
    <alias name="" index="8" field="Anlagentyp"/>
    <alias name="" index="9" field="Durchmesser"/>
    <alias name="" index="10" field="Nabenhoehe"/>
    <alias name="" index="11" field="Stand"/>
    <alias name="" index="12" field="Beschreibung"/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="MastrID" expression=""/>
    ...
    <default applyOnUpdate="0" field="Genehmigungsjahr" expression=""/>
    <default applyOnUpdate="0" field="Leistung_kW" expression=""/>
    <default applyOnUpdate="0" field="Anlagentyp" expression=""/>
    <default applyOnUpdate="0" field="Durchmesser" expression=""/>
    <default applyOnUpdate="0" field="Nabenhoehe" expression=""/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="MastrID"/>
    ...
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="Genehmigungsjahr"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="Leistung_kW"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="Anlagentyp"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="Durchmesser"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0" field="Nabenhoehe"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="MastrID"/>
    <constraint desc="" exp="" field="PLZ"/>
    <constraint desc="" exp="" field="Gemeinde"/>
    <constraint desc="" exp="" field="Inbetriebnahmejahr"/>
    <constraint desc="" exp="" field="Genehmigungsjahr"/>
    <constraint desc="" exp="" field="Leistung_kW"/>
    <constraint desc="" exp="" field="Anlagentyp"/>
    <constraint desc="" exp="" field="Durchmesser"/>
    <constraint desc="" exp="" field="Nabenhoehe"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column hidden="0" name="MastrID" width="-1" type="field"/>
      ...
      <column hidden="0" name="Genehmigungsjahr" width="-1" type="field"/>
      <column hidden="0" name="Leistung_kW" width="-1" type="field"/>
      <column hidden="0" name="Anlagentyp" width="-1" type="field"/>
      <column hidden="0" name="Durchmesser" width="-1" type="field"/>
      <column hidden="0" name="Nabenhoehe" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="Durchmesser" editable="1"/>
    <field name="Gemeinde" editable="1"/>
    <field name="Genehmigungsjahr" editable="1"/>
    <field name="Inbetriebnahmejahr" editable="1"/>
    <field name="LANUV_ID" editable="1"/>
    <field name="Leistung_kW" editable="1"/>
    <field name="MastrID" editable="1"/>
    <field name="Nabenhoehe" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="Durchmesser" labelOnTop="0"/>
    <field name="Gemeinde" labelOnTop="0"/>
    <field name="Genehmigungsjahr" labelOnTop="0"/>
    <field name="Inbetriebnahmejahr" labelOnTop="0"/>
    <field name="LANUV_ID" labelOnTop="0"/>
    <field name="Leistung_kW" labelOnTop="0"/>
    <field name="MastrID" labelOnTop="0"/>
    <field name="Nabenhoehe" labelOnTop="0"/>
