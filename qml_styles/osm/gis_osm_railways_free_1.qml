...
<qgis styleCategories="AllStyleCategories" labelsEnabled="1" maxScale="1" simplifyDrawingHints="1" readOnly="0" version="3.10.4-A Coruña" hasScaleBasedVisibilityFlag="1" minScale="1.2e+07" simplifyMaxScale="1" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyLocal="1">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0">
    <rules key="{0d36de44-6814-4fea-a48c-d678277f9bd4}">
      <rule filter="&quot;fclass&quot; IN ('rail')" key="{ef4a1766-84ef-49df-942e-f6ca90136319}" label="rail">
        <rule symbol="0" scalemindenom="1" scalemaxdenom="1000" key="{a137db37-cd31-4253-b1c5-3eb3db294309}" label="1 - 1000"/>
        <rule symbol="1" scalemindenom="1000" scalemaxdenom="5000" key="{dfe0066e-e98c-46de-b4df-9f91460319f0}" label="1000 - 5000"/>
        <rule symbol="2" scalemindenom="5000" scalemaxdenom="10000" key="{b2f1f114-018d-4a4d-8729-254b207e1bdd}" label="5000 - 10000"/>
        <rule symbol="3" scalemindenom="10000" scalemaxdenom="50000" key="{6d9b7579-e7ca-4e6f-9b36-814bfa7cd4b7}" label="10000 - 50000"/>
        <rule symbol="4" scalemindenom="50000" scalemaxdenom="100000" key="{df961215-3ceb-4255-b7e5-8f0ffd109788}" label="50000 - 100000"/>
        <rule symbol="5" scalemindenom="100000" scalemaxdenom="500000" key="{39a38785-70c7-47f5-87f5-9da184cd62df}" label="100000 - 500000"/>
        <rule symbol="6" scalemindenom="100000" scalemaxdenom="1500000" key="{db8eaeb2-9c8f-431a-aae1-e725341f6ec9}" label="500000 - 1500000"/>
      </rule>
      <rule filter="&quot;fclass&quot;  = 'subway'" key="{1ae0a46a-29c6-40c6-90a1-ac7f052a6d45}" label="subway">
        <rule symbol="7" scalemindenom="1" scalemaxdenom="1000" key="{bc7efc8d-5a88-4c29-bec5-7194fdcb6f47}" checkstate="0" label="1 - 1000"/>
        <rule symbol="8" scalemindenom="1000" scalemaxdenom="5000" key="{ed4f3d6c-e478-43b7-b2b0-0fdcd80f1cc4}" checkstate="0" label="1000 - 5000"/>
        <rule symbol="9" scalemindenom="5000" scalemaxdenom="10000" key="{3a1c8d1a-563e-4aaa-bfce-1e7647844226}" checkstate="0" label="5000 - 10000"/>
        <rule symbol="10" scalemindenom="10000" scalemaxdenom="50000" key="{095f39e7-d491-4b7e-bef8-2ff8ce5ff69d}" checkstate="0" label="10000 - 50000"/>
        <rule symbol="11" scalemindenom="50000" scalemaxdenom="100000" key="{0286444b-3a16-4f64-9313-e204f69103fc}" checkstate="0" label="50000 - 100000"/>
      </rule>
      <rule filter="&quot;fclass&quot; IN ( 'tram', 'light_rail')" key="{76cf0e67-e783-425f-9da4-513c917c8eba}" label="tram">
        <rule symbol="12" scalemindenom="1" scalemaxdenom="1000" key="{30f7ad94-e1d8-4579-962b-0e1d1254a653}" label="1 - 1000"/>
        <rule symbol="13" scalemindenom="1000" scalemaxdenom="5000" key="{4c3f0b2e-0e66-4c1b-b2e1-1063068bc738}" label="1000 - 5000"/>
        <rule symbol="14" scalemindenom="5000" scalemaxdenom="10000" key="{b756372a-a933-4bbf-8851-94232a1ca414}" label="5000 - 10000"/>
        <rule symbol="15" scalemindenom="10000" scalemaxdenom="50000" key="{224012c7-b0ea-4651-9f64-fa3e400daca8}" label="10000 - 50000"/>
        <rule symbol="16" scalemindenom="50000" scalemaxdenom="100000" key="{370f9358-3cd7-4ef9-8009-14a3f28dcaaa}" label="50000 - 100000"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontItalic="0" fontKerning="1" fontLetterSpacing="0" namedStyle="Regular" fontStrikeout="0" fontCapitals="0" previewBkgrdColor="0,0,0,255" blendMode="0" useSubstitutions="0" fontUnderline="0" multilineHeight="1" fontFamily="Noto Sans" fontWordSpacing="0" fontWeight="50" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fieldName="name" textColor="72,72,72,255" fontSize="6.5" isExpression="0" fontSizeUnit="Point" textOrientation="horizontal">
        <text-buffer bufferSize="0.5" bufferSizeUnits="MM" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferNoFill="0" bufferBlendMode="0" bufferDraw="1" bufferJoinStyle="64"/>
      ...
      <text-format wrapChar="" autoWrapLength="0" decimals="3" rightDirectionSymbol=">" placeDirectionSymbol="0" multilineAlign="0" useMaxLineLengthForAutoWrap="1" formatNumbers="0" addDirectionSymbol="0" plussign="0" leftDirectionSymbol="&lt;" reverseDirectionSymbol="0"/>
      <placement repeatDistanceUnits="MM" xOffset="0" offsetUnits="MapUnit" maxCurvedCharAngleOut="-20" geometryGenerator="" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleIn="20" preserveRotation="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" quadOffset="4" layerType="LineGeometry" centroidInside="0" centroidWhole="0" overrunDistanceUnit="MM" geometryGeneratorEnabled="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="3" dist="0" fitInPolygonOnly="0" placementFlags="9" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5" yOffset="0" overrunDistance="0" geometryGeneratorType="PointGeometry" distUnits="MM" repeatDistance="80" distMapUnitScale="3x:0,0,0,0,0,0"/>
      <rendering labelPerPart="0" maxNumLabels="20" upsidedownLabels="0" limitNumLabels="0" minFeatureSize="0" obstacle="1" fontMaxPixelSize="10000" zIndex="0" scaleMax="10000000" scaleMin="1" fontMinPixelSize="3" fontLimitPixelSize="0" obstacleFactor="1" displayAll="0" scaleVisibility="1" obstacleType="0" mergeLines="1" drawLabels="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
