...
<qgis labelsEnabled="0" readOnly="0" simplifyLocal="1" version="3.10.4-A Coruña" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyMaxScale="1" maxScale="0" simplifyAlgorithm="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer">
    <rules key="{af5d7592-652b-43f2-a8dc-778627e8a4d6}">
      ...
      <rule key="{48bb13cb-9292-4323-bba7-268cc304c402}" symbol="7" checkstate="0" label="Anteil Fernwärme in %">
        <rule key="{f2aa7bc0-b207-4b12-8686-8d2d686a4b30}" symbol="8" filter="0 &lt;= ( 100 * &quot;Fernwärme&quot; /   &quot;beheizte_WonGeb_sum_ALKIS&quot;  ) AND  ( 100 * &quot;Fernwärme&quot; /   &quot;beheizte_WonGeb_sum_ALKIS&quot;  ) &lt; 5" checkstate="0" label="Fernwärmeanteil 0 bis 5 %"/>
        <rule key="{6cc09977-8c45-4e90-b6fc-5c1970b12dc2}" symbol="9" filter="5 &lt;= ( 100 * &quot;Fernwärme&quot; /  &quot;beheizte_WonGeb_sum_ALKIS&quot; ) AND  ( 100 * &quot;Fernwärme&quot; /   &quot;beheizte_WonGeb_sum_ALKIS&quot;  ) &lt; 10" label="Fernwärmeanteil 5 bis 10 %"/>
        <rule key="{7f5b0e2b-ff60-4851-8412-463593d259d8}" symbol="10" filter="10 &lt;= ( 100 * &quot;Fernwärme&quot; /  &quot;beheizte_WonGeb_sum_ALKIS&quot; ) AND  ( 100 * &quot;Fernwärme&quot; /   &quot;beheizte_WonGeb_sum_ALKIS&quot;  ) &lt; 15" label="Fernwärmeanteil 10 bis 15 %"/>
        <rule key="{e345b859-7880-4e17-bea7-555a7add65df}" symbol="11" filter="15 &lt;= ( 100 * &quot;Fernwärme&quot; /  &quot;beheizte_WonGeb_sum_ALKIS&quot; ) AND  ( 100 * &quot;Fernwärme&quot; /   &quot;beheizte_WonGeb_sum_ALKIS&quot;  ) &lt; 20" label="Fernwärmeanteil 15 bis 20 %"/>
        <rule key="{267da3e2-4f0b-47bb-bcab-9649df8aae79}" symbol="12" filter=" ( 100 * &quot;Fernwärme&quot; /  &quot;beheizte_WonGeb_sum_ALKIS&quot; ) > 20" label="Fernwärmeanteil größer gleich 20 %"/>
      </rule>
    </rules>
    <symbols>
